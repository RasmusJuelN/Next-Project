...
[Index(nameof(TemplateTitle), IsUnique = true)]
...
[Index(nameof(TemplateTitle), nameof(Id), IsDescending = [false, false])]
[Index(nameof(TemplateTitle), nameof(Id), IsDescending = [true, false])]
