...
import { ShowResultsComponent } from './components/dashboard/teacher-dashboard/show-results/show-results.component';
...
export const routes: Routes = [
    { path: '', component: LoginPageComponent },
    {
      ...
      { path:'testing/:id', component: ShowResultsComponent},
