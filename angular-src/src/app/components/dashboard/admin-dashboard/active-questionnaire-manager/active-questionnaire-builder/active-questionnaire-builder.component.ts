    ...
    switch (searchType) {
      case 'student':
        if (this.hasMoreStudents) {
          ...
          this.dataService.getUsersFromSearch('student', searchQuery, this.searchStudentPage, this.limit, this.studentCacheCookie)
            .subscribe(response => {
      ...
      case 'teacher':
        if (this.hasMoreTeachers) {
          ...
          this.dataService.getUsersFromSearch('teacher', searchQuery, this.searchTeacherPage, this.limit, this.teacherCacheCookie)
            .subscribe(response => {
